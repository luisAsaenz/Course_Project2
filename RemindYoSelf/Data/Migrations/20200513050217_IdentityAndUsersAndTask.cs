...
{
    public partial class IdentityAndUsersAndTask : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SumOfTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SumOfTasks_TaskTypes_TaskTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SumOfTasks_TaskTypeId",
                table: "SumOfTasks",
                column: "TaskTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SumOfTasks_UserId",
                table: "SumOfTasks",
                column: "UserId");
